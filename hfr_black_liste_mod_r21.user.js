...
function hfr_gestion_masquage(event) {
	if (hfr_GM_getValue(cle_masquage_total, false)) {
		...
		event.target.src = event.target.srcImgExclamation;
	} else {
		hfr_GM_setValue(cle_masquage_total, true);
		event.target.src = event.target.srcImgAccept;
	}	
}
...
function creerDivMasquage() {
		...
		inputMasquage.srcImgExclamation = 'data:image/png;base64,';
		inputMasquage.srcImgAccept = 'data:image/png;base64,';
		inputMasquage.type = 'image';
		inputMasquage.style.marginLeft = '6px';
		if (hfr_GM_getValue(cle_masquage_total, false)) {
			inputMasquage.src = inputMasquage.srcImgAccept;
		} else {
			inputMasquage.src = inputMasquage.srcImgExclamation;
		}		
...
({
	check4Update : function()
	{
		...
		var currentVersion = GM_getValue('currentVersion', '0.7.0');
		// On met éventuellement la version stockée à jour avec la version courante, si la version courante est plus récente
		if (autoUpdate.isLater('0.7.0', currentVersion))
		{
			GM_setValue('currentVersion', '0.7.0');
		...
		else if (autoUpdate.isLater(currentVersion, '0.7.0'))
		{
