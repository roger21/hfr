...
// 0.1.1.3 (07/11/2019) :
// - amélioration du code pour une meilleur compatibilité
// 0.1.1.2 (02/10/2019) :
...
var cats = document.querySelectorAll("div#mesdiscussions.mesdiscussions table.main tbody " +
                                     "tr.cBackHeader.fondForum1fCat");
cats.forEach(function(cat)
  {
    if(!cat.nextElementSibling ||
       (cat.nextElementSibling.classList.contains("cBackHeader") &&
        cat.nextElementSibling.classList.contains("fondForum1fCat")))
    {
      cat.style.display = "none";
    }
    else if (cat.nextElementSibling.classList.contains("sujet") &&
             !cat.nextElementSibling.classList.contains("ligne_booleen"))
    {
      cat.style.display = "none";
