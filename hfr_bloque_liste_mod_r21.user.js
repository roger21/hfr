...
// historique :
// 4.2.3 (23/09/2023) :
// - gestion du support pour [HFR] Live après le chargement complet du script
// 4.2.2 (21/09/2023) :
// - gestion de la mise à jour des boutons et du filtrage après les chargements de [HFR] Live
// 4.2.1 (04/12/2022) :
...
l_style.textContent =
  ...
  "table.messagetable.gmhfrblr21_with_blocked_quote_type.gmhfrblr21_hidden > " +
  "tbody > tr:not(.gmhfrblr21_snippet_type), " +
  // premier message de la reponse normale
  "div#mesdiscussions.mesdiscussions > table.main.gmhfrblr21_blocked_type.gmhfrblr21_hidden > " +
  "tbody > tr.reponse + tr.reponse:not(.gmhfrblr21_snippet_type), " +
  "div#mesdiscussions.mesdiscussions > " +
  "table.main > tbody > tr.reponse + tr.reponse > td.messCase1bis + td " +
  "div.container.gmhfrblr21_blocked_type.gmhfrblr21_hidden > table:not(.gmhfrblr21_snippet_type), " +
  "div#mesdiscussions.mesdiscussions > " +
  "table.main.gmhfrblr21_with_blocked_quote_type.gmhfrblr21_hidden > " +
  "tbody > tr.reponse + tr.reponse:not(.gmhfrblr21_snippet_type), " +
  // reponse normale
  "div#mesdiscussions.mesdiscussions > " +
...
function update_styles() {
  ...
  if(gmhfrblr21_color_hidden) {
    ...
    l_new_blocked_style.textContent = gmhfrblr21_always_color_snippets ?
      ...
      // premier message de la réponse normale
      "div#mesdiscussions.mesdiscussions > " +
      "table.main.gmhfrblr21_blocked_type > " +
      "tbody > tr.reponse + tr.reponse > td{background-color:" + l_hidden_rgba + ";}" +
      "div#mesdiscussions.mesdiscussions > " +
      "table.main > tbody > tr.reponse + tr.reponse > td.messCase1bis + td " +
      "div.container.gmhfrblr21_blocked_type > " +
      "table.citation{background-color:" + l_hidden_rgb_combined + ";}" +
      ...
      // premier message de la réponse normale
      "div#mesdiscussions.mesdiscussions > " +
      "table.main.gmhfrblr21_blocked_type:not(.gmhfrblr21_hidden) > " +
      "tbody > tr.reponse + tr.reponse > td{background-color:" + l_hidden_rgba + ";}" +
      "div#mesdiscussions.mesdiscussions > " +
      "table.main > tbody > tr.reponse + tr.reponse > td.messCase1bis + td " +
      "div.container.gmhfrblr21_blocked_type:not(.gmhfrblr21_hidden) > " +
  ...
  if(gmhfrblr21_color_posts_with_hidden) {
    ...
    l_new_with_blocked_quote_style.textContent = gmhfrblr21_always_color_snippets ?
      ...
      // premier message de la réponse normale
      "div#mesdiscussions.mesdiscussions > " +
      "table.main.gmhfrblr21_with_blocked_quote_type > " +
      "tbody > tr.reponse + tr.reponse > td{background-color:" + l_posts_with_hidden_rgba + ";}" +
      // réponse normale
      "div#mesdiscussions.mesdiscussions > " +
      ...
      // premier message de la réponse normale
      "div#mesdiscussions.mesdiscussions > " +
      "table.main.gmhfrblr21_with_blocked_quote_type:not(.gmhfrblr21_hidden) > " +
      "tbody > tr.reponse + tr.reponse > td{background-color:" + l_posts_with_hidden_rgba + ";}" +
      // réponse normale
...
function hide_posts() {
  let l_post_authors;
  if(reponse_normale) {
    l_post_authors = document.querySelectorAll(
      "div#mesdiscussions.mesdiscussions > table.main > " +
      "tbody > tr.reponse + tr.reponse > td.messCase1bis," +
  ...
  for(let l_post_author of l_post_authors) {
    ...
    if(is_normalized_pseudo_blocked(l_normalized_pseudo)) {
      let l_post_tr;
      if(reponse_normale) {
        l_post_tr = l_post_author.parentElement;
      } else {
        l_post_tr = l_post_author.parentElement.parentElement.parentElement;
      }
      ...
      if(reponse_normale) {
        if(l_post_tr.classList.contains("reponse")) {
          l_snippet.classList.add("reponse");
          l_snippet.style.textAlign = "center";
        } else if(l_post_tr.hasAttribute("style")) {
...
function hide_quotes() {
  let l_quotes;
  if(reponse_normale) {
    l_quotes = document.querySelectorAll(
      "div#mesdiscussions.mesdiscussions > table.main > " +
      "tbody > tr.reponse + tr.reponse > td.messCase1bis + td " +
      "div.container:not(.gmhfrblr21_blocked_type) > table.citation, " +
      "div#mesdiscussions.mesdiscussions > table.main > " +
      "tbody > tr.reponse + tr.reponse > td.messCase1bis + td " +
      "div.container:not(.gmhfrblr21_blocked_type) > table.oldcitation," +
      "div#mesdiscussions.mesdiscussions > form#hop ~ form#apercu_form ~ table > " +
      "tbody > tr.message > td.messCase1bis + td " +
      "div.container:not(.gmhfrblr21_blocked_type) > table.citation, " +
      "div#mesdiscussions.mesdiscussions > form#hop ~ form#apercu_form ~ table > " +
      "tbody > tr.message > td.messCase1bis + td " +
      "div.container:not(.gmhfrblr21_blocked_type) > table.oldcitation");
  ...
  if(gmhfrblr21_parameters[profile].h) {
    let l_snippets;
    if(reponse_normale) {
      l_snippets = document.querySelectorAll(
        "div#mesdiscussions.mesdiscussions > table.main.gmhfrblr21_blocked_type > " +
        "tbody > tr.reponse + tr.reponse.gmhfrblr21_snippet_type:not(.gmhfrblr21_with_always_hide_snippets)," +
        "div#mesdiscussions.mesdiscussions > form#hop ~ form#apercu_form ~ " +
  ...
  if(gmhfrblr21_parameters[profile].h) {
    ...
    if(reponse_normale) {
      l_post_trs = document.querySelectorAll(
        "div#mesdiscussions.mesdiscussions > table.main.gmhfrblr21_with_blocked_quote_type > " +
        "tbody > tr.reponse + tr.reponse:not(.gmhfrblr21_snippet_type)," +
        "div#mesdiscussions.mesdiscussions > " +
        "form#hop ~ form#apercu_form ~ table.gmhfrblr21_with_blocked_quote_type > " +
        "tbody > tr.message:not(.gmhfrblr21_snippet_type)");
    ...
    if(reponse_normale) {
      l_post_trs = document.querySelectorAll(
        "div#mesdiscussions.mesdiscussions > " +
        "table.main:not(.gmhfrblr21_blocked_type):not(.gmhfrblr21_with_blocked_quote_type) > " +
        "tbody > tr.reponse + tr.reponse," +
        "div#mesdiscussions.mesdiscussions > form#hop ~ form#apercu_form ~ " +
    ...
    for(let l_post_tr of l_post_trs) {
      if(l_post_tr.querySelector("div.container.gmhfrblr21_blocked_type") !== null) {
        let l_pseudo;
        if(reponse_normale) {
          l_pseudo = l_post_tr.querySelector(":scope > td.messCase1bis").firstChild.nodeValue;
        } else {
          l_pseudo =
...
Promise.all([
  ...
  // détection de la page de réponse normale
  reponse_normale = document.querySelector("div#mesdiscussions.mesdiscussions > " +
    "form#hop ~ form#apercu_form ~ table") !== null;
    ...
    if(category !== null) {
      let l_transsearch =
        document.querySelector("div#mesdiscussions.mesdiscussions " +
          "table.main tr th form[action=\"/transsearch.php\"] > input[name=\"post\"], " +
          "div#mesdiscussions.mesdiscussions > " +
          "form#hop[action=\"/bddpost.php?config=hfr.inc\"] > input[name=\"post\"]");
  ...
  if(do_debug) {
    console.log(
      "DEBUG [HFR] Bloque liste reponse_normale : ",
      reponse_normale);
    console.log(
  ...
  /* -------------------------------------------------------------------------- */
  /* mise à jour des boutons et du filtrage après les chargements de [HFR] Live */
  /* -------------------------------------------------------------------------- */
