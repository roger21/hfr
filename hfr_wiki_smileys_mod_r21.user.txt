...
({
	check4Update : function()
	{
		...
		var currentVersion = GM_getValue('currentVersion', '0.6.2a');
		// On met éventuellement la version stockée à jour avec la version courante, si la version courante est plus récente
		if (autoUpdate.isLater('0.6.2a', currentVersion))
		{
			GM_setValue('currentVersion', '0.6.2a');
			currentVersion = '0.6.2a';
		}			
		...
		else if (autoUpdate.isLater(currentVersion, '0.6.2a'))
		{
