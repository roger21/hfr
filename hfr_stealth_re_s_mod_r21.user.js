...
// 2.1.0.s (23/02/2016) :
// - version statique : les aliases sont en dur dans le script
// 2.1.0 (30/12/2015) :
...
var cmScript = {
  ...
  timer: null,
  aliases: {
    ["Principal : reho.st"]: "reho.st",
    ["Oxygen3 (a-suivre.com)"]: "rehost.a-suivre.com",
    ["Oxygen3 (a-suivre.org)"]: "rehost.a-suivre.org",
    ["roger21 (netlib.re)"]: "rehost.netlib.re",
    ["roger21 (codelib.re)"]: "rehost.codelib.re",
    ["roger21 (changeip.org)"]: "rehost.changeip.org",
    ["roger21 (mynumber.org)"]: "rehost.mynumber.org"
  },
  ...
  createConfigMenu: function() {
    GM_registerMenuCommand("[HFR] stealth rehost statique -> configuration", this.showConfigWindow);
  }
};
cmScript.setUp();
