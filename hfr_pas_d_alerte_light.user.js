...
Copyright © 2018-2020, 2026 roger21@free.fr
...
// historique :
// 1.0.7 (06/04/2026) :
// - bidouille pour éviter que le bouton d'alerte ait une taille nulle (bug du script)
// 1.0.6 (13/02/2020) :
...
for(let button of buttons) {
  ...
  // taille fixe du bouton pour éviter le redimensionnement lors de l’affichage du throbber
  // en mode shadow uniquement, en mode icons on laisse les images avoir leur taille réelle
  if(!icons) {
